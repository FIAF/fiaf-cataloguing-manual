...
of two or more films onto one reel/tape/DVD etc. for convenient storage.[^fn2]
...
[^fn2]: See Appendix [Aggregate or Carrier](/docs/13_appendix_05/identifying_aggregates/#sec-aggregate_or_carrier)
