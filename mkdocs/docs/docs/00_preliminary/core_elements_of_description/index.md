...
### Core elements of description[^fn1]
...
| Series / Serial [^fn2] | 1.3.2 Title [Work] | 1.3.2.1 Title Type = Series/Serial [Work] |
...
| Subject/Genre/Form [^fn3] | 1.4.3 Subject/Genre/Form terms [Work] |  |
...
See [Example 1. Feature film in 3-level, 2-level and 1-level hierarchies](/docs/18_appendix_10/#sec-example_one) as an illustration.

Please see [Elements of Description comparison](/docs/16_appendix_08/) comparison for a list of all elements described in this manual.
...
![](/diagrams/0.2.1-B.png)
![](/diagrams/0.2.1-C.png)
![](/diagrams/0.2.1-D.png)
