...
They follow The Chicago manual of style[^fn1] for the sake of consistency.
...
Examples of complete entries may be found in [Examples of records containing core elements in the different levels of hierarchy](/docs/18_appendix_10/).
Examples of the elements of description in different data structures are shown in [Elements of Description comparison](/docs/16_appendix_08/).
The bibliography follows ISO 690.

[^fn1]: University of Chicago. 2003. The Chicago manual of style. Chicago, Ill: University of Chicago Press.
