---
title: Rights/Copyright/IPR Registration
---
<a id="sec-rights_in_a_moving_image_work"></a>
## Rights in a moving image Work
...
<a id="sec-background_information"></a>
...
<a id="sec-authors_of_a_moving_image_work"></a>
#### Authors of a moving image Work
...
However, between 1923-2002 there were periods where other formalities needed to be followed in order to retain copyright: during some periods, a Item required “notice” (a copyright symbol or statement) on the work; in other periods, the Work had to be renewed in the 28th year after initial publication.[^fn1]
...
<a id="sec-layers_of_protection_for_the_work_as_abstraction_and_the_fixation_or_recording_of_the_work_in_a_concrete_form"></a>
#### Layers of protection for the ‘work’ as abstraction, and the ‘fixation’ or ‘recording’ of the work in a concrete form
...
The United States has not yet passed legislation on orphan works, but the Register of Copyrights is actively seeking to change the laws.[^fn2]
...
<a id="sec-rights_protected_works"></a>
#### Rights-protected works that may be used within, or created during, a film production
...
<a id="sec-recommended_properties_to_capture1"></a>
### Recommended properties to capture in describing the rights context of a moving image Work
...
[^fn1]: For guidance on copyright terms in the US, see Peter Hirtle’s chart “Copyright terms and the public domain in the United States,” updated annually. http://copyright.cornell.edu/resources/publicdomain.cfm
[^fn2]: Priorities and special projects of the United States Copyright Office (October 2011), http://copyright.gov/docs/priorities.pdf
