...
---
<a id="sec-other_relationships_for_works_variants_manifestations_items"></a>
...
| “Contains” | Compilation, series/serial, (see [Aggregates (Compilations, Multi-component productions)](/docs/13_appendix_05/)). |
| “Is Contained in”/ “is part of” | Episode, number, part, extra (see [Aggregates (Compilations, Multi-component productions)](/docs/13_appendix_05/)). |
| “Has a sequential relationship with” | Sequel, prequel, serial/series (see [Aggregates (Compilations, Multi-component productions)](/docs/13_appendix_05/)). |
...
| “Contains” | Compilation (unintentional – mere use of the same carrier: see [Aggregates (Compilations, Multi-component productions)](/docs/13_appendix_05/)) |
| “Is Contained in”/ “is part of” | Episode, number, part, etc. included in an unintentional/convenient compilation (see [Aggregates (Compilations, Multi-component productions)](/docs/13_appendix_05/)). |
