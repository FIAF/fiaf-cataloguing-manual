...
- International Standard Audiovisual Number (ISAN)[^fn2]
- EIDR (Entertainment Identifier Registry)[^fn3]
- VIAF (Virtual International Authority File).[^fn4]
- Locally-generated
...
If the country name has changed, record the name of the country as it was at the time of production, e.g., Czechoslovakia for a Work/Variant produced in 1970, but Czechia or Slovakia for one from 2012.[^fn9]
...
[^fn2]: [www.isan.org](www.isan.org)
[^fn3]: [www.eidr.org](www.eidr.org)
[^fn4]: [www.viaf.org](www.viaf.org)
