# 2.3.5 Extent of a Manifestation [^96]<a name="manual-2.3.5"/>
...
[^96]: Partially based on EN 15907, 6.8 except for the physical components/units number, which is not provided for in the standard.