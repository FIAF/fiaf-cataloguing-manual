...
Provide access to Agents when they have made an important contribution to the particular Work or Variant, even when the type of responsibility (credit function) is one that may not be considered major in other Works/Variants or types of Works/Variants.[^2]
...
Preserving the ordering of the credited persons should be determined by the requirements of individual institutions.[^4] 
