...
Provide access to Agents when they have made an important contribution to the particular Manifestation, even when the type of responsibility (credit function) is one that may not be considered major in other Manifestations.[^2] 
...
<a id="sec-agent_responsible_for_preservation"></a>
...
<a id="sec-agent_responsible_for_reproduction_or_transfer"></a>
...
<a id="sec-agent_responsible_for_the_archival_availability"></a>
...
<a id="sec-agent_responsible_for_the_mere_availability"></a>
...
<a id="sec-agent_unclea_or_undetermined"></a>
...
<a id="sec-agent_not_identified"></a>
