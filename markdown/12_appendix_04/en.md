...
\hline
\textbf{Film Gauge} & \textbf{Video} & \textbf{Audio} & \textbf{Optical} & \textbf{Digital File} & \textbf{Digital File Encoding} \\
\hline
...
\hline
\textbf{Work/Variant Other Relationship Types} & \textbf{Term list}  \\
\hline
...
\begin{tabularx}{\textwidth}{|X|X|}
\hline
\textbf{Other Relationship Types (strictly pertaining to the Manifestation)} & \textbf{Term list}  \\
\hline
“is part of” & part \\ 
\hline
“Has a relationship to promotional material ” & trailer, promo, banner, press-kit, poster, etc. \\ 
...
\begin{tabularx}{\textwidth}{|X|X|}
\hline
\textbf{Item Other Relationship Types} & \textbf{Term list}  \\
\hline
...
\hline
“Access copy of/Has Access copy” & E.g. an MP4 viewing access copy created from a preservation of a master DPX AND
“Source of/Has Source” AND In-house copying of held Items creating new Items, e.g. to create a viewing copy, copy on a different format, copy Nitrate to Safety etc. \\ 
\hline
...
\hline
\textbf{FORM TERM} & \textbf{USE} & \textbf{EXAMPLES}  \\
\hline
