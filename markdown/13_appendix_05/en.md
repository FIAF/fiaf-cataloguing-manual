...
With these there was no original intention for the components to be independent^[Although where these are made by both different directors and production companies there may have been dual consideration of potential future independent release], and there should always be a single Monographic Work record with a single Manifestation for them.
...
The aggregating Work may or may not be deemed important enough to be recorded.^[Working Group on Aggregates. Final Report of the Working Group on Aggregates, September 12, 2011, [http://www.ifla.org/files/assets/cataloguing/frbrrg/AggregatesFinalReport.pdf](http://www.ifla.org/files/assets/cataloguing/frbrrg/AggregatesFinalReport.pdf)]”
...
![](/app/src/diagrams/figure_16.png){width=400px}
