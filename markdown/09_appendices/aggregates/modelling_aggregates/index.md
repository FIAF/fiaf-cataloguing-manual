...
For how aggregate records may be structured in a 1-level hierarchy system see [Example 7. Aggregate DVD Television Serial and Episode records in 1-level Hierarchy Models](/09_appendices/record-examples/example_seven/#sec-example_seven).
...
There is the option of an institution using a devised/supplied title (see [Supplied/Devised Titles (i.e. Creating titles for untitled/unidentified entities or production material)](/09_appendices/titles/title_types/#sec-supplied_devised_titles)).
