...
The component titles may additionally be added to the aggregating Work as alternative title types (see [Alternative](/09_appendices/titles/title_types/#sec-alternative)).
They may also be added to any Items as alternative title types.

Titling of aggregates follows the same principles as that of other types of entities (see [Titles and Title Types](/09_appendices/titles/)).
...
(See [Title Proper](/09_appendices/titles/title_types/#sec-title_proper) or [Supplied/Devised Titles (i.e. Creating titles for untitled/unidentified entities or production material)](/09_appendices/titles/title_types/#sec-supplied_devised_titles)).
