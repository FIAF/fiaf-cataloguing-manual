...
For guidance on wording, order, spelling, punctuation, accentuation and capitalisation, see [Purpose](/00_preliminary/purpose_scope_and_use/#sec-purpose).

For sources of information for the Title, see [Sources of Information](/00_preliminary/prelim_sources_of_information/#sec-prelim_sources_of_information).
...
## Preferred
The title of a moving image Work or Variant when first released, broadcast, published or transmitted (i.e. mounted online) in the country or countries of origin ( see [Country of Reference](/02_variants/elements_of_a_variant/#sec-country_of_reference).
...
See [Moving images with probable or questionable titles](/09_appendices/titles/moving_images_with_probable_or_questionable_titles/#sec-moving_images_with_probable_or_questionable_titles).
...
When no title at all can be found for a Work or Variant, follow the procedure set out in the [Supplied/Devised Titles (i.e. Creating titles for untitled/unidentified entities or production material)](/09_appendices/titles/title_types/#sec-supplied_devised_titles) section.
...
Where separate fields do not exist, create an identifying title using the preferred title of the Work/Variant as the starting point (if no title, see [Partially Supplied/Devised Titles](/09_appendices/titles/title_types/#sec-partially_supplied_devised_titles)).[^8]
...
It is the chief name of any Manifestation and represents the primary access point.[^11]

Ideally record in a note or dedicated field the source of the title proper.

If it is impossible to determine the title proper or if the Manifestation is the embodiment of a Work not intended to have a formal title, construct a supplied/devised title (see [Supplied/Devised Titles (i.e. Creating titles for untitled/unidentified entities or production material)](/09_appendices/titles/title_types/#sec-supplied_devised_titles)).
...
In particular, where an incomplete physical product of the Manifestation has been acquired (see [Analytics/Components of identified newsreels/cinemagazines](/09_appendices/titles/title_types/#sec-analytics_components_of_identified_newsreels_cinemagazines)).
...
Ideally, the title proper of an Item is determined by the following:
  ...
  iv) In the absence of either (i) or (ii), and either not catalogued within a WVMI structure, or Work and Manifestation have not yet been identified, then a supplied/devised title should be created. In the latter instance, any subsequently created Work and Manifestation to be linked to the Item record should have the same title and a supplied/devised title type (See [Supplied/Devised Titles (i.e. Creating titles for untitled/unidentified entities or production material)](/09_appendices/titles/title_types/#sec-supplied_devised_titles)).
...
If a general material designation is used, place it after the preferred title and before other title information.[^14]
...
Abridge other title information only if this can be done without essential loss of information.[^15]
...
transliteration, such as [ISO 9](https://www.iso.org/standard/3589.html) (not to be confused with the Parallel title).[^22]
...
important (either for identification or for access).[^23]
...
(see [Title](/02_variants/elements_of_a_variant/#sec-work_title))
...
The title itself should be descriptive, describing the Work as succinctly as possible.[^29]
...
This may not be appropriate in all cases.[^35]
...
For a more comprehensive list of form terms to use with for FULLY or PARTIALLY Supplied/Devised titles, see [List of form terms for Supplied/Devised titles](/09_appendices/value-lists/list_of_form_terms_for_supplied_devised_titles/#sec-list_of_form_terms_for_supplied_devised_titles).
...
The series/serial title may be indicated within (i) the title field itself, or (ii) reflected in a linked hierarchical relationship with an individual Serial Work level record, i.e. a Work assigned the Description Type “Serial[^40]; or (iii) added as a Title Type; or (iv) a combination.
...
Newsreels and cinemagazines[^42] usually consisted of several separate reports that were all analytics/components of a particular issue, and also usually had inter-title headings within the newsreel itself.
...
<a id="sec-further_enhanced_structuring_possibilities_with analytic_component_parts_and_identified_newsreels_cinemagazines"></a>
### Further enhanced structuring possibilities with analytic/component parts and identified newsreels/cinemagazines
...
The Item title is assigned in accordance with [Title](/04_items/elements_of_a_moving_image_item/#sec-item_title) and [Supplied/Devised Titles (i.e. Creating titles for untitled/unidentified entities or production material)](/09_appendices/titles/title_types/#sec-supplied_devised_titles).
...
For example, a reel of a silent fiction film with no title given on either the print or can, or any indication of what it is, other than it is clearly part of a longer film, should be assigned a relevant Item title in accordance with the guidelines in [Supplied/Devised Titles (i.e. Creating titles for untitled/unidentified entities or production material)](/09_appendices/titles/title_types/#sec-supplied_devised_titles), for example:
...
[^30]: This section, including form terms and examples, is based on or taken from FIAF 1.4.3 Additions to titles;Yee/UCLA 5.1.2; AMIM2 1F1.1
[^31]: Taken almost wholly from Yee/UCLA, 5.2.2.1. Unidentified materials released or broadcast with a title
[^32]: The punctuation used is less important than following a consistent order and conforming to standard terminology.
[^33]: Adapted from DACS, 2.3.18, pp. 20-21.
[^34]: Adapted from DACS, 2.3.18, pp. 20-21.
[^35]: Based on Yee/UCLA, 5.2.3
[^36]: DACS, 2.3.4, p. 18.
[^37]: DACS, 2.3.4, p. 18.
[^38]: Adapted from DACS, 2.3.22, p. 22.
...
[^40]: See Appendix [Work/Variant Description Types](/01_works/work_variant_description_types/#sec-work_variant_description_types) for EN 15907/BFI definitions of Serial as Description Type.
...
[^43]: See [Value Lists](/09_appendices/value-lists/) for CEN categories and definitions used by BFI
[^44]: See [Supplied/Devised Titles (i.e. Creating titles for untitled/unidentified entities or production material)](/09_appendices/titles/title_types/#sec-supplied_devised_titles) and examples of titling
