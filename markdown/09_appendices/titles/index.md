...
When recording a title, apply the guidelines on capitalisation, numbers, diacritical marks, initial articles, spacing of initials and acronyms, and abbreviations, in [Purpose](/00_preliminary/purpose_scope_and_use/#sec-purpose).
...
See [Notes](/02_variants/elements_of_a_variant/#sec-notes).
...
[^1]: Adapted from RDA 5.4 Language and Script
