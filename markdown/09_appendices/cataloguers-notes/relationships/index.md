...
Record details on producer, place of production, date of production or on any other possible related changes.[^2]

**Publication**

Record details on publisher (distributor, etc.), place of publication (includes place of distribution, release, etc.), date of publication, or on any other possible related changes.[^3]

**Manufacture**

Record details on the manufacturer (i.e. laboratory, studio, etc….), place of manufacture, date of manufacture, or on any other possible related changes.[^4]

**“Other relationships”**

Record any additional information concerning all those relationships that are not covered by the Agent and Event relationships, the so-called “Other relationships” (see [Work/Variant Other Relationship Types](/08_other-relationships/other_relationships_for_works_variants_manifestations_items/#sec-work_variant_other_relationship_types)).
