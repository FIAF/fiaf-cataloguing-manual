...
It is recognised that field names in different institutions’ systems will not necessarily use identical terms to those of the core concepts or this manual (see [Core elements of description](/00_preliminary/core_elements_of_description/#sec-core_elements_of_description)).
...
Example 1 depicts 3-level, 2-level and 1 level model hierarchies (see [Elements of description across Works, Variants, Manifestations, and Items](/00_preliminary/core_elements_of_description/#sec-elements_of_description)) for the same film.
...
Fields and data in black are additional elements and data, that also mainly correspond with the wider Attributes, Elements and Relationships stipulated in CEN EN 15907 and found at [Moving Image Works](/08_other-relationships/#sec-moving_image_works), [Moving Image Manifestations](/03_manifestations/), and [Moving Image Items](/04_items/).

Core concepts ([Core elements of description](/00_preliminary/core_elements_of_description/#sec-core_elements_of_description))
