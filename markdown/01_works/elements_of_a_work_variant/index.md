...
If your institution is applying the use of “Type” qualifiers, use “Title Type” to state the function of a particular title (see [Title Type](/01_works/elements_of_a_work_variant/#sec-work_title_type) and [Titles and Title Types](/09_appendices/titles/)).
...
It may differ from the title found on a particular manifestation of the Work; the actual title on the Manifestation is noted in the Manifestation Title element (see [Title](/03_manifestations/elements_of_a_manifestation/#sec-manifest_title)).
See [Title Types](/09_appendices/titles/title_types/#sec-title_types) for additional information.

For creating titles for untitled or unidentified entities see [Supplied/Devised Titles (i.e. Creating titles for untitled/unidentified entities or production material)](/09_appendices/titles/title_types/#sec-supplied_devised_titles).Television programmes and other types of content that are part of a series/serial should have both the series/serial title and the episode title included in the Work record.
This may be via use of a “Title type” qualifier.
See [Titles and structuring of series/serials](/09_appendices/titles/title_types/#sec-titles_of_series_serials) for other options.
...
See [Title](/09_appendices/titles/#sec-appendix_title) for fuller titling details and information.

See [Titling of Aggregates](/09_appendices/aggregates/titling_of_aggregates/#sec-titling_of_aggregates) for titling of Aggregates (e.g., compilations).
...
### Date Type
The year or date should be associated with an event in the life cycle of the Work or its Variants (see [Events (e.g., IPR registration, screenings, awards, etc.)](/01_works/relationships_of_a_work_variant/#sec-work_events)).
...
For a list of initial terms, see [Event Type](/07_events/event_type/#sec-event_type).
...
(See guidelines for language in a Manifestation: [Language](/03_manifestations/elements_of_a_manifestation/#sec-manifest_language))
