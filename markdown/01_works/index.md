...
## Definitions[^1]
Brief definitions of the standard CEN terms Work/Variant/Manifestation/Item used in the Manual were provided at the end of the Introduction (see [Introduction](/00_preliminary/#sec-introduction)).
...
It also reflects the original intentions of its realisation, including: circumstances of the creation process such as date(s) and place(s) of production, most contributions by agents such as directors, screenwriters, production companies and cast members, as well as certain statements about the contents.[^2]
...
*Moving Images created by use of automatic devices such as surveillance cameras, scientific or medical instruments, etc.*[^5][^6].
...
[^1]: For a discussion of other definitions of the “Work” and Variant entities, see [Moving Image Works](/08_other-relationships/#sec-moving_image_works).
