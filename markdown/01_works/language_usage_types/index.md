...
Optionally, record language usage type at the Manifestation/Item level (see [Language](/03_manifestations/elements_of_a_manifestation/#sec-manifest_language)).
A value of “original” can be added to the Language element here to indicate that statements made about the language(s) for a particular Manifestation/Item are indicative of the language(s) of the “original” Work. [^2]
...
If acceptable summaries are already available in secondary sources, cataloguers may use these, instead of taking the time to prepare summaries of their own. If using summaries exactly as written, put the summary in quotes and note the source of the summary.[^3]
...
Otherwise a general description of scenes and sequences will suffice[^5].
...
Include a qualifying keyword or otherwise denote the type of summary (e.g. Synopsis, Shotlist, Review).[^6]

<a id="sec-notes"></a>
## Notes
Notes for moving image Works/Variants are annotations providing additional information or clarification relating specifically to Works/Variants attributes and relationships.[^7] See [Cataloguer’s Notes](/09_appendices/cataloguers-notes/).
...
### Censorship History
Document information related to the censorship history of a Work/Variant, including:[^8]
...
[^2]: The indication of “original” values at the Manifestation level follows EN 15907 attributes of a Manifestation, pp. 10-11
[^3]: FIAF 7.2.12. Summary
[^4]: FIAF 7.2.16. Contents
[^5]: Irish Film Archive, p. 23.
[^6]: EN 15907, 6.17.3 Elements, Description type, p. 30.
[^7]: Based on RDA 2.20.1.Basic Instructions on Making Notes on Manifestations or Items
[^8]: EN 15907, 6.13 Decision event, pp. 26-27.
