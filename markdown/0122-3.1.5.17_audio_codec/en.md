...
Select from controlled list of terms. A suggested list, which is open and not exhaustive, can be found in [D.7.10 Item Codec type](#manual-D.7.10). Other lists include:
