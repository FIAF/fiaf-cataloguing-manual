...
\newpage
\section[Cataloguer’s Notes]{Cataloguer’s Notes 
...
Examples:^[Adapted from FIAF 7.1.3 Form of notes]
...
\subsection[Boundaries]{Boundaries 
...
Examples:^[FIAF 7.2.7. History of edition/version/variation]
...
Examples ^[FIAF 7.2.8.2. Names and Functions] ^[FIAF 7.2.12. Series]:
...
Work Examples:^[Examples taken from RDA 2.20.2.3 Title Source, 2.20.2.4 Title variations, Inaccuracies, and Deletions; RDA 5.9.1.3 Making Cataloguer’s Notes; and FIAF 7.2 Notes]
...
Family camping trip through the Canadian
  ...
  [Note] Date from notes accompanying item, attached to inventory, and from Merlo Pusey’s Eugene Meyer, (New York: Knopf, 1974), p.195.
^[FIAF, p. 65]
