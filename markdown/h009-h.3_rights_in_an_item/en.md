\subsection{H.3 Rights in an Item}
\label{sec:manual-H.3}
...
However, this section only applies to archives and libraries with specific qualifications.[^248] The current Register of Copyrights has set revising Section 108 as one of her priorities.[^249]
