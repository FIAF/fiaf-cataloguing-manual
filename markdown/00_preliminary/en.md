...
For a comparison of elements described in this Manual and EN 15907, please see [Appendix G, Elements of Description comparison]\nameref{sec:elements_of_description_comparison}.
...
Optionally, additional non-preferred title types may also be added to assist in user searching and accessibility (see [Appendix A, Titles and Title Types]\nameref{sec:titles_and_title_types}).
...
Examples of complete entries may be found in [Appendix I, Examples of records containing core elements in the different levels of hierarchy]\nameref{sec:examples_of_records}.
Examples of the elements of description in different data structures are shown in [Appendix G, Elements of Description comparison]\nameref{sec:elements_of_description_comparison}.
...
In RDA, the title is provided as transcribed without a recognition of the misspelling, with the correct title added in a secondary set of Title and Title Type fields (see [A.2.4.1 Alternative title types]\nameref{sec:alternative_title_types}) and a Note explaining the misspelling.
