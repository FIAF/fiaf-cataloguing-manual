...
See [Example 1. Feature film in 3-level, 2-level and 1-level hierarchies](/09_appendices/record-examples/#sec-example_one) as an illustration.

Please see [Elements of Description comparison](/09_appendices/element-comparison/) comparison for a list of all elements described in this manual.
...
See [Examples of records containing core elements in the different levels of hierarchy](/09_appendices/record-examples/) for examples of real records which contain these core elements (as well as others) across the hierarchies.
