...
In RDA, the title is provided as transcribed without a recognition of the misspelling, with the correct title added in a secondary set of Title and Title Type fields (see [Alternative title types](/09_appendices/titles/title_types/#sec-alternative_title_types)) and a Note explaining the misspelling.
