...
When taking details and information from secondary source materials then cite those sources, either in relevant notes fields on a record as a [Cataloguer’s Notes](/09_appendices/cataloguers-notes/), or linking to a related non-moving image collection record within your institution's database systems if relevant, e.g. a related associative link to a book record or periodical article record. 
