...
Examples of complete entries may be found in [Examples of records containing core elements in the different levels of hierarchy](/09_appendices/record-examples/).
Examples of the elements of description in different data structures are shown in [Elements of Description comparison](/09_appendices/element-comparison/).
The bibliography follows ISO 690.

[^1]: University of Chicago. 2003. The Chicago manual of style. Chicago, Ill: University of Chicago Press.
