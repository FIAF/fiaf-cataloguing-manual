# 2.2 Attributes of a Manifestation<a name="manual-2.2"/>
...
Record the Manifestation Type by taking the most suitable term from a controlled list. A suggested list, which is open and not exhaustive, can be found in [D.5 Manifestation Types](#manual-D.5).
