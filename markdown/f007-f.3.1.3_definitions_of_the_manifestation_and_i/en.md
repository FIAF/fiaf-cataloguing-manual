\subsection{F.3.1.3 Definitions of the Manifestation and Item Entities}
\label{sec:manual-F.3.1.3}
...
It may be whole or incomplete or a fragment.
In the case of purely digital media, an Item is defined as the availability of the computer file, irrespective of the number of backup copies that may exist[^238].
