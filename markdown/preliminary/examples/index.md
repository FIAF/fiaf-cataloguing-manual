...
Examples of complete entries may be found in [Examples of records containing core elements in the different levels of hierarchy](/appendices/record-examples/).
Examples of the elements of description in different data structures are shown in [Elements of Description comparison](/appendices/element-comparison/).
