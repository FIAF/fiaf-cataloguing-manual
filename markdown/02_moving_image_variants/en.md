...
\subsection[Relationships of a Variant (links/associations with other entities/records)]{Relationships of a Variant (links/associations with other entities/records)
    \label{sec:relationships_of_a_variant}
    }
