...
In the above scenario each of the Items could be given the same location/container/barcode number and each could have the alternative title of “Victorian Cinema 3”.
