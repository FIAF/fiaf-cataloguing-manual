...
See “Shallow hierarchy model: 2 levels” in [Elements of description across Works, Variants, Manifestations, and Items](/00_preliminary/core_elements_of_description/#sec-elements_of_description)).
...
This chapter contains Item-specific physical/digital description elements beginning at Section 3.1.5 (see [Item Specifics/Extent (e.g. physical/Digital description)](/04_items/elements_of_a_moving_image_item/#sec-item_specifics_extent).
...
If multiple titles are recorded, where allowable, associate a “Title Type” to a title for differentiation between the various types of titles (see [Title Types](/09_appendices/titles/title_types/#sec-title_types)).
...
For creating titles for untitled or unidentified entities see [Supplied/Devised Titles (i.e. Creating titles for untitled/unidentified entities or production material)](/09_appendices/titles/title_types/#sec-supplied_devised_titles)
...
For Items where the only title information is found on a can or leader, use an Acquisition Title Type(s) (see [Alternative title types](/09_appendices/titles/title_types/#sec-alternative_title_types)) or descriptive words such as “Title on can” or “Title on leader.”
...
Further data relating to the condition, preservation, location, and, acquisition, accessioning, and source of the Item are also recommended elements for the Item (see [Access Conditions](/04_items/elements_of_a_moving_image_item/#sec-access_conditions)).
...
<a id="sec-sound"></a>
### Sound
Technical specifications relating to the fixation of sound in a moving image Manifestation/Item (see [Sound Characteristics of a Manifestation](/03_manifestations/elements_of_a_manifestation/#sec-sound_characteristics_of_a_manifestation)).
...
### Sound System
See also [Sound Characteristics of a Manifestation](/03_manifestations/elements_of_a_manifestation/#sec-sound_characteristics_of_a_manifestation)
...
<a id="sec-colour"></a>
### Colour
For full instructions, see [Colour Characteristics of a Manifestation](/03_manifestations/elements_of_a_manifestation/#sec-colour_characteristics_of_a_manifestation).
...
### Unit Number
For full instructions see [Logical Extent of a Manifestation](/03_manifestations/elements_of_a_manifestation/#sec-logical_extent_of_a_manifestation)
...
This footage represents actual length, rather than the “ideal” length, which is recorded for Manifestations (see [Physical Extent of a Manifestation](/03_manifestations/elements_of_a_manifestation/#sec-physical_extent_of_a_manifestation)).
...
For full instructions, see [Projection Characteristics of a Manifestation{](/03_manifestations/elements_of_a_manifestation/#sec-projection_characteristics_of_a_manifestation)
...
This duration represents actual temporal extent, rather than the “ideal” temporal extent, which is recorded for Manifestations (see [Duration of a Manifestation](/03_manifestations/elements_of_a_manifestation/#sec-duration_of_a_manifestation)).
...
Information related to the frame rate used during a digitisation process is added to Transfer Speed (see [Transfer Speed](/04_items/elements_of_a_moving_image_item/#sec-transfer_speed)).
...
### Transfer Speed
If the Transfer Speed is the same as the [Frame Rate](/04_items/elements_of_a_moving_image_item/#sec-frame_rate), these values should be the same.
...
Record these actions as an Event (see [Events](/04_items/relationships_of_an_item/#sec-items_events)), with the person or entity performing the action as an Agent (see [sec:items_agents](#sec-items_agents)).
...
If possible, use the Item Identifier and Identifier Type fields to note an Item’s location (see [Identifier](/04_items/elements_of_a_moving_image_item/#sec-item_identifier)).
...
## Notes for Items
Notes for Items are an annotation providing additional information relating specifically to Item attributes and relationships.[^7] See [Cataloguer’s Notes](/09_appendices/cataloguers-notes/).
