...
Fields and data in black are additional elements and data, that also mainly correspond with the wider Attributes, Elements and Relationships stipulated in CEN EN15907 and found at [Moving Image Works](/other-relationships/#sec-moving_image_works), [Moving Image Manifestations](/manifestations/), and [Moving Image Items](/items/).
