...
- Pre-release title: A provisional title, given to the Manifestation before the release or publication with the definitive title of the related Work.^[Based on FIAF 1.3.]

- Abbreviated title: A title given in order to designate it quickly by the institution.^[Based on FIAF 1.3.]
...
Parallel title).^[Based on FIAF 1.3.]
...
\subsubsection{Titles and structuring of series/serials} 
...
\paragraph{Further enhanced structuring possibilities with large newsreel/cinemagazine or television series/serials} 
\label{sec:further_enhanced_structuring_possibilities_with_large_newsreel_cinemagazine_or_television_series_serials} \
