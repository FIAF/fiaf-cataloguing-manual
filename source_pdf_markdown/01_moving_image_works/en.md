...
Works may have one-to-many relationships with instances of Variant and Manifestation/Item and many-to-many relationships with instances of Agent(s,) Event(s), Content(s), Subject(s) and Other Relation(s). ^[Adapted from the definition of a Cinematographic Work in EN 15907, 4.1.1, p.8.]
...
*Moving Images created by use of automatic devices such as surveillance cameras, scientific or medical instruments, etc.*^[Adapted from the definition of a Cinematographic Work in EN 15907, 4.1.1, p.8.]^[These are invented examples for illustrative purposes].
