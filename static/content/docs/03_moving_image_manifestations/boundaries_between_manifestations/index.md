...
weight: 1
---
<a id="sec-boundaries_between_manifestations"></a>
### Boundaries between Manifestations
The boundaries between one Manifestation and another are drawn on the basis of two criteria: changes in the publication context and changes in format.[^fn1] The distinction between one Manifestation and another can be made according to one of the two criteria or the presence of both.

<a id="sec-changes_in_the_publication_context"></a>
#### Changes in the Publication Context
...
A suggested list, which is open and not exhaustive, can be found at [Manifestation Types](/docs/12_appendix_04/manifestation_types/#sec-manifestation_types)
...
Include and describe any of the distinguishing physical changes according to the guidelines in [Format of a Moving Image Manifestation](/docs/03_moving_image_manifestations/elements_of_a_manifestation/#sec-format_of_a_moving_image_manifestation).
...
[^fn1]: The definitions that individuate a “new” M. I. Manifestation and distinguish one from another are mainly based on YEE 2008 (draft), 81.
[^fn2]: Information about the cinematographic process and aspect ratio is taken from: http://www.imdb.it/title/tt0057091/technical.
