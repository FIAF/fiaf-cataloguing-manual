...
The number of websites stating the same “fact” is not a safe indicator. Websites copy off each other and it is easy for an erroneous fact to be perpetuated across multiple websites[^fn9](https://collections-search.bfi.org.uk/web/Details/People/177651)]. The cataloguer needs to assess, balance, and judge accuracy, e.g. IMDB and Wikipedia can be good for information, but they also allow submissions and changes from the public so it is not necessarily always accurate.
...
[^fn7]: Ibid.
[^fn8]: Ibid.
[^fn9]: See the name note on the [BFI record for Richard Greene
