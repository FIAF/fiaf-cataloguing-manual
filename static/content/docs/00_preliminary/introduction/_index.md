---
title: Dedication, acknowledgement and introduction
weight: 1
---
## Dedication
...
While these guidelines are intended to be applicable to all forms of moving image materials, archives with extensive broadcasting collections may wish to look to broadcasting-specific metadata schemas such as EBUCore[^fn6](https://tech.ebu.ch/MetadataEbuCore)] and PBCore[^fn7](http://pbcore.org/)] for additional guidance.
...
In the case of purely digital media, an Item is defined as the availability of the computer file, irrespective of the number of backup copies that may exist.[^fn8](http://filmstandards.org/fsc/index.php/EN_15907_Item)]
...
[^fn3]: The other two conceptual models are FRAD (Functional Requirements for Authority Data), [http://www.ifla.org/node/7923
[^fn4]: FRBR Final Reports, p. 3.
[^fn5]: RDA 0.0 and 0.1, p. 0-1.
[^fn6]: [https://tech.ebu.ch/MetadataEbuCore
[^fn7]: [http://pbcore.org/
[^fn8]: Taken from EN15907. Item – Definition from the standard. [http://filmstandards.org/fsc/index.php/EN_15907_Item
