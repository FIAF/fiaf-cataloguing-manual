...
weight: 1
---
<a id="sec-attributes_of_a_moving_image_work_variant"></a>
### Attributes of a Moving Image Work
<a id="sec-work_variant_description_type"></a>
#### Work Description Type[^fn1]
...
The terms used in this Manual are derived from traditional bibliographic cataloguing rules and from EN 15907 (and are defined in Appendix D.1), but an institution may choose to create its own list of terms. See [Work/Variant Description Types](/docs/12_appendix_04/#sec-work_variant_description_types).

[^fn1]: EN 15907, 4.1.2 Attributes—description Level, p. 8; BFI CID Stylistics Manual, A.1.3 Filmographic Level, pp. 7-8
