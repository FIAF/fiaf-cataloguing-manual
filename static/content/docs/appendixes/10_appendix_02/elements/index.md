...
Resource described is a translation of the French language edition.[^fn3]

  Title of work is clearly, Ten nights in a bar room; however, several versions of this film were produced between 1910-1931.
It is probable that this work is the 1921 version, but due to vagueness of available plot summaries and disappearance of copyright descriptive material for the 1921 version, date cannot be verified at this time.[^fn4]
...
If the moving image Work/Variant associated with the moving image Manifestation in hand had sound originally, but the Manifestation lacks sound, describe it as silent (or mute) and give a note to that effect.[^fn6]
...
If the duration/running time of a Manifestation/Item is uncertain, give an explanation for the estimated duration/running time, if such information applies.[^fn7]
...
[^fn1]: Examples taken from RDA 2.20.2.3 Title Source, 2.20.2.4 Title variations, Inaccuracies, and Deletions; RDA 5.9.1.3 Making Cataloguer’s Notes; and FIAF 7.2 Notes
[^fn2]: FIAF, p. 65
[^fn3]: RDA 2.20.10.3 Details Relating to Copyright Dates
[^fn4]: FIAF 7.2.7. History of edition/version/variation
[^fn5]: Based on FIAF 7.2.2. Language
[^fn6]: Based on AMIM2 5C3.
[^fn7]: Based on FIAF 1991, 5.3.4.2.
