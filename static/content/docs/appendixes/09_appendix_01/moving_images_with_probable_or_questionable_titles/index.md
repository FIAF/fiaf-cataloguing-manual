...
### Moving images with probable or questionable titles[^fn1]
...
(See [Supplied/Devised Titles (i.e. Creating titles for untitled/unidentified entities or production material)](/docs/09_appendix_01/title_types/#sec-supplied_devised_titles)).
...
Example concerning an Archive holding a copy of the Italian version of an unidentified American silent comedy, with Italian intertitles [^fn2] [^fn3]:
...
Examples of partially and fully supplied titles for a variety of scenarios can be found in the “form terms” list provided in [List of form terms for Supplied/Devised titles](/docs/12_appendix_04/list_of_form_terms_for_supplied_devised_titles/#sec-list_of_form_terms_for_supplied_devised_titles).

[^fn1]: Based on AMIM2, 1F2.1.
[^fn2]: Many archives place information found on the Manfestation/Item in quotes to indicate the data is transcribed from the physical item itself or the audiovisual content of the entity. This practice is not recommended unless required by local cataloguing rules or local system requirements.
[^fn3]: This example has since been identified as the film Grandpa’s Girl (United States of America, 1924 – Gil Pratt)
