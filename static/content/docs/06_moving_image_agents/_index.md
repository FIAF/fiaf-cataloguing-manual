...
weight: 7
---
For recording the attributes of Agents (e.g. first name, last name, nationality, etc.), refer to authoritative sources such as AACR2, applicable RDA chapters for recording attributes of Persons, Families, and Corporate Bodies,[^fn1] Functional requirements for authority data: a conceptual model, [^fn2]  or tools such as the Virtual International Authority File (VIAF) (viaf.org), Library of Congress Linked Data Service (id.loc.gov), Getty Union List of Artists Names (ULAN), the [Library of Congress Name Authority File](https://authorities.loc.gov/cgi-bin/Pwebrecon.cgi?RefCodes=3&ref=1&hd=1,1&SEQ=20130523194229&Search_Arg=Ethnology-United%20States&Search_Code=SHED_&CNT=100&PID=mYzkzT0fYryqza3XpBkr08lSvjsf&SID=8), or International Standard Name Identifier (ISNI) 126.127 
...
Typical distinctions between Agent types are Person, Corporate Body, Family, and Person Group.[^fn3] 
...
Provide access to Agents when they have made an important contribution to the particular Work or Variant, even when the type of responsibility (credit function) is one that may not be considered major in other Works/Variants or types of Works/Variants.[^fn4]
...
If the relationship is ambiguous, use a value to indicate this, for example, “unknown” or “on-screen participant” to indicate a person appearing on screen in a capacity that is indeterminate or not covered by typical terms.[^fn5] 
...
Preserving the ordering of the credited persons should be determined by the requirements of individual institutions.[^fn6] 
...
[^fn1]: RDA 2.20.7.3
[^fn2]: Patton, Glenn E. 2009. Functional requirements for authority data: a conceptual model. München: K.G. Saur.
[^fn3]: EN 15907, 5.1 Agent
[^fn4]: 1991 FIAF Cataloguing Rules for Film Archives – Statements of Responsibility, p. 35.
[^fn5]: ist of relator terms are a combination of those found in YCR, 1.3.2. Other creators, pp. 42-43; and, OLAC TF, Part II, Core Attributes and Relationships, Commonly-Occurring Roles, pp. 16-18.
[^fn6]: FIAF, 1.6.2, pp. 36-37.
