...
weight: 1
---
<a id="sec-agents_for_manifestations"></a>
### Agents for Manifestations
...
Typical distinctions between agent types are Person, Corporate Body, Family and Person Group.[^fn1]  
...
Provide access to Agents when they have made an important contribution to the particular Manifestation, even when the type of responsibility (credit function) is one that may not be considered major in other Manifestations.[^fn2] 
...
<a id="sec-agent_activity_manifestations"></a>
#### Agent Activity – Manifestations
...
If the relationship is ambiguous, use a value to indicate this, for example, “unknown” to indicate a person performing in a capacity that is uncertain or not covered by typical terms.[^fn3] 
...
[^fn1]: EN 15907, 5.1 Agent
[^fn2]: YCR, 1.3.2. Other creators, p. 42.
[^fn3]: List of relator terms are a combination of those found in YCR, 1.3.2. Other creators, pp. 42-43; and, OLAC TF, Part II, Core Attributes and Relationships, Commonly-Occurring Roles, pp. 16-18.
